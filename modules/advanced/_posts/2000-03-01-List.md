...
public class Elves {
    ...
    public void OrderByName() {
        list.Sort((a, b) => return a.CompareName(b)); // Lambda expressie (uitleg: zie onder voorbeeld)
    }

    // De functie OrderByAge() sorteert de lijst oplopend op Age.
    public void OrderByAge() {
        list.Sort((a, b) => return a.CompareAge(b)); // Lambda expressie (uitleg: zie onder voorbeeld)
    }
