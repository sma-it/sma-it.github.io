...
```
 Vanaf C# 9.0 is de syntax nogmaals gewijzigd en zal het vorige voorbeeld met de operatoren nog verkort gecodeerd kunnen worden. Zoals je merkt, is het belangrijk evoluties in
 programmeertalen op te volgen.
