...
* De som maakt van de twee functieparameters indien de eerste functieparamter groter is dan of gelijk is aan de tweede.
* Het verschil maakt van de twee functieparameters indien de eerste functieparamter kleiner is dan de tweede.
...
* CalcNumbers: naam van de functie. We spreken af dat functies een duidelijke naam krijgen die aangeeft wat de functie doet.
* (): na de functienaam vinden we ronde haakjes. Deze haakjes kunnen leeg zijn of er kunnen functieparameters meegegeven worden. (zie voorbeelden)
...
<div class="header2" markdown = "1">## Een functie van het type void
</div>
...
Een functie wordt gedefinieerd door zijn naam en zijn lijst van functieparameters. Elke functie moet uniek gedefinieerd zijn, zodat er geen dubbelzinnigheid ontstaat en de compiler weet welke functie er voor een functieaanroep gebruikt moet worden.
...
* elke functie heeft een verschillend __aantal__ functieparameters.
* elke functie heeft een verschillend __type__ van functieparameters.

Op bovenstaande manier unieke functies met dezelfde naam creëren is `function overloading`.

### Voorbeeld: function overloading a.h.v. het aantal functieparameters
...
### Voorbeeld: function overloading a.h.v. het type functieparameters
...
Opmerking:
Bij versie twee van de functie Maximum gebruiken we een method uit de class string, namelijk Compare. Deze method returnt volgende waarden afhankelijk van de onderlinge positie van de strings:
* de eerste string komt volgens de sorteerorde voor de tweede: <0
* beide strings hebben volgens de sorteerorde een gelijke positie: 0
* de eerste string komt volgens de sorteerorde na de tweede: >0
...
class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("The last name alphabetically: {lastAlphabet}");
            Console.ReadKey();
        }
    }
```
