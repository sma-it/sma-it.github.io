...
Let er steeds op dat je bij het schrijven van een functie de optionele argumenten als laatste vermeld in de lijst met functieargumenten. Het is immers niet toegelaten posities van argumenten over te slaan bij de functieaanroep. Bijgevolg moeten de optionele argumenten als laatste vermeld worden.

<div class="note oefening">
<p>Open het project [Oefening functies](https://github.com/sma-it/oefening-functies-1) en maak oefenreeks 1</p>
</div>
...
<div class="note oefening">
<p>Open het project [Oefening functies](https://github.com/sma-it/oefening-functies-1) en maak oefenreeks 2</p>
</div>

## Reference argumenten

Er bestaan twee manieren om functieargumenten door te geven aan een functie:
* pass by value
* pass by reference

### Pass by value

Tot nu toe werd er in de voorbeelden steeds pass by value gebruikt. De functieargumenten werden gebruikt om waarden door te geven aan de functie, die op haar beurt deze waarden kon gebruiken. Indien pass by value gebruikt wordt, zal er niets gewijzigd worden aan de oorspronkelijke variabelen die als functieargument gebruikt werden. De oorspronkelijke waarden worden a.h.w. gekopieerd in de functieargumenten.

Een voorbeeld: De functie berekent de tweedemacht van het functieargument.
...
```csharp
    ...
    static void Main(string[] args)
    {
        ...
        System.Console.WriteLine("The value before calling the function: {0}", n);

        // Gebruik van pass by value bij het doorgeven van de variabele n aan de functie.
        // De variabele n wordt in x gekopieerd en de functie werkt met deze kopie. Als gevolg
        // blijft n onveranderd.
        int s = SquareIt(n);

        System.Console.WriteLine("The result of the function: {0}", s);

        System.Console.WriteLine("The value after calling the function: {0}", n);
...
*/
``` 
Na het uitvoeren van de functie heeft n nog steeds dezelfde waarde. De oorspronkelijke variabele werd dus enkel gebruikt als invoer voor de functie en werd niet gewijzigd door de functie.

### Pass by reference

Indien dezelfde functie uitgevoerd wordt met pass by reference dan wijzigt de variabele n die als functieargument gebruikt wordt wel. Bij een pass by reference wordt er immers geen kopie van de oorspronkelijke variabele in het functieargument geplaatst. Het functieargument krijgt als inhoud een verwijzing naar de adresplaats van de variabele die bij de functieaanroep gebruikt wordt. 

```csharp
    public static void SquareIt(ref int x) // het keyword 'ref' zorgt voor de pass by reference
    {
        x *= x;
    }
    static void Main(string[] args)
    {
        ...
        SquareIt(ref n);  // x verwijst nu naar n. Wat met x gebeurt, gebeurt ook met n.
        System.Console.WriteLine("The value after calling the function: {0}", n);
...
### Een array als argument van een functie

Een array zal steeds als een reference argument aan een functie doorgegeven worden, ook al wordt het keyword `ref` niet gebruikt. Enkel als de array binnen de functie via `new` een nieuwe plaats in het geheugen toegewezen krijgt, vervalt de referentie.

In onderstaand voorbeeld wijzigt een eenvoudige functie het eerste element van de array. Ook al wordt bij het argument `ref` niet gebruikt, toch wordt de array met een referentie aan de functie doorgegeven. Buiten de functie is het eerste element van de array immers ook gewijzigd.

```csharp
    public static void ChangeFirstNumber(int[] pArray)
    {
        pArray[0] = 888;
    }
    ...
    class Program
    {
        static void Main(string[] args)
        {
        int[] numbers = new int[] { 5, -3, -7, 3, 8, -1, 9, 10, -6, -7 };
    ...
    /* Output
    888 -3 -7 3 8 -1 9 10 -6 -7
    */
```

Bij het maken van de oefeningen zal je merken dat je d.m.v. het gebruik van reference argumenten meerdere variabelen kan laten wijzigen door een functie, terwijl dit met een return-instructie slechts één variabele is.

<div class="note oefening">
    <p>Open het project <a href="https://github.com/sma-it/oefening-functies-1">oefening-functies-1</a> en maak oefenreeks 3</p>
</div>
