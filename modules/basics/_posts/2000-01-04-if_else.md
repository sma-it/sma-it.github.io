...
Deze code kan korter geschreven worden. Het else-gedeelte kan immers vermeden worden door de variabele discountPerc op voorhand te initialiseren op 0.03F en slechts indien nodig te wijzigen naar 0.05F:
