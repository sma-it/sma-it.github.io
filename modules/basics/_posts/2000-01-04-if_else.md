...
public static int test(int a)
{
    if (a < 1 || a > 100) // de twee voorwaarden worden gekoppeld OR (||)
    {
        a = 100;
    }
    return a;
...
{
    if (a < min || a > max) // de twee voorwaarden worden gekoppeld met OR (||)
    {
        a = max;
    }
    return a;
...
public static string Result(int score)
{
    ...
    if (score < 5)
    {
        resultText = "Fail";
                         ...
                         // Alle scores lager dan 5 worden reeds afgehandeld 
                         // in het eerste deel 
